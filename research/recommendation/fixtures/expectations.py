...
def _relative(scenario_id: str, higher: str, lower: str, rationale: str, *, deferred: bool = False) -> dict:
    entry = {
...
EXPECTATIONS: dict[str, dict] = {
    "scn-A-explicit-more-001": _entry(
        ...
        ["IN-1", "IN-4", "IN-5"],
        [
            _hard("scn-A-explicit-more-001", "target", eligibility_state=E, explanation_codes_include=["EXPLICIT_INTEREST_MATCH"]),
            _hard("scn-A-explicit-more-001", "control", eligibility_state=E),
    ...
    "scn-B-explicit-less-001": _entry(
        ...
        ["IN-1", "IN-4"],
        [
            _hard("scn-B-explicit-less-001", "target", eligibility_state=E, exclusion_reasons=[]),
            _hard("scn-B-explicit-less-001", "control", eligibility_state=E),
        ],
    ...
    "scn-C-explicit-paused-001": _entry(
        ...
        [
            ...
            _hard("scn-C-explicit-paused-001", "control", eligibility_state=E),
    ...
    "scn-D-not-interested-001": _entry(
        ...
        [
            ...
            _hard("scn-D-not-interested-001", "control", eligibility_state=E),
        ],
        [],
        ["exclusion_count_by_reason"],
    ),
    ...
    "scn-I-difficulty-too-low-001": _entry(
        ...
        ["IN-1", "IN-5"],
        [
            _hard("scn-I-difficulty-too-low-001", "too_low", eligibility_state=E),
            _hard("scn-I-difficulty-too-low-001", "appropriate", eligibility_state=E),
            _hard("scn-I-difficulty-too-low-001", "too_high", eligibility_state=E),
        ],
    ...
    "scn-J-difficulty-appropriate-001": _entry(
        ...
        ["IN-1", "IN-5"],
        [
            _hard("scn-J-difficulty-appropriate-001", "appropriate", eligibility_state=E),
            _hard("scn-J-difficulty-appropriate-001", "too_low", eligibility_state=E),
            _hard("scn-J-difficulty-appropriate-001", "too_high", eligibility_state=E),
        ],
        [
    ...
    "scn-K-difficulty-too-high-001": _entry(
        ...
        ["IN-1", "IN-5"],
        [
            _hard("scn-K-difficulty-too-high-001", "too_high", eligibility_state=E),
            _hard("scn-K-difficulty-too-high-001", "appropriate", eligibility_state=E),
            _hard("scn-K-difficulty-too-high-001", "too_low", eligibility_state=E),
        ],
    ...
    "scn-L-semantic-neighbor-001": _entry(
        ...
        ["IN-1", "IN-5", "IN-8"],
        [
            _hard("scn-L-semantic-neighbor-001", "near", eligibility_state=E, explanation_codes_include=["SEMANTICALLY_RELATED"]),
            _hard("scn-L-semantic-neighbor-001", "far", eligibility_state=E),
    ...
    "scn-M-graph-neighbor-001": _entry(
        ...
        ["IN-1", "IN-5", "IN-8"],
        [
            _hard("scn-M-graph-neighbor-001", "distance_1", eligibility_state=E),
            _hard("scn-M-graph-neighbor-001", "distance_2", eligibility_state=E),
    ...
    "scn-N-continuation-001": _entry(
        ...
        ["IN-1", "IN-5"],
        [
            _hard("scn-N-continuation-001", "target", eligibility_state=E, explanation_codes_include=["RELATED_TO_RECENT_EXPLORATION"]),
            _hard("scn-N-continuation-001", "control", eligibility_state=E),
        ],
    ...
    "scn-O-revisit-001": _entry(
        ...
        ["IN-1", "IN-5"],
        [
            _hard("scn-O-revisit-001", "target", eligibility_state=E, explanation_codes_include=["REVISIT_OPPORTUNITY"]),
            _hard("scn-O-revisit-001", "control", eligibility_state=E),
        ],
    ...
    "scn-P-diversity-pressure-001": _entry(
        ...
        ["IN-1", "IN-2"],
        [
            _hard("scn-P-diversity-pressure-001", "cluster_a", eligibility_state=E),
            _hard("scn-P-diversity-pressure-001", "cluster_b", eligibility_state=E),
            _hard("scn-P-diversity-pressure-001", "spread", eligibility_state=E),
            _hard("scn-P-diversity-pressure-001", rerank_only_reorders_eligible=True),
        ],
        [_relative("scn-P-diversity-pressure-001", "spread", "cluster_a", "diversity may lift spread above redundant same-domain cluster", deferred=True)],
    ...
    "scn-Q-deterministic-tie-001": _entry(
        ...
        ["IN-1", "IN-7"],
        [
            _hard("scn-Q-deterministic-tie-001", "target_a", eligibility_state=E),
            _hard("scn-Q-deterministic-tie-001", "target_b", eligibility_state=E),
        ...
        [_relative("scn-Q-deterministic-tie-001", "target_a", "target_b", "equal score inputs resolve by frozen tiebreak key ascending", deferred=True)],
    ...
    "scn-R-multisource-duplicate-001": _entry(
        ...
        ["IN-1", "IN-8"],
        [
            _hard("scn-R-multisource-duplicate-001", "target", eligibility_state=E),
    ...
    "scn-S-sparse-learner-001": _entry(
        ...
        ["IN-1", "IN-5", "IN-6"],
        [
            _hard("scn-S-sparse-learner-001", "target", eligibility_state=E, exclusion_reasons=[]),
    ...
    "scn-X2-not-interested-inferred-positive-001": _entry(
        ...
        [
            ...
            _hard("scn-X2-not-interested-inferred-positive-001", "control", eligibility_state=E),
    ...
    "scn-X3-three-source-duplicate-001": _entry(
        ...
        ["IN-1", "IN-5", "IN-8"],
        [
            _hard("scn-X3-three-source-duplicate-001", "target", eligibility_state=E),
            _hard("scn-X3-three-source-duplicate-001", "graph_only", eligibility_state=E),
    ...
    "scn-X4-diversity-ineligible-001": _entry(
        ...
        ["IN-1", "IN-2"],
        [
            _hard("scn-X4-diversity-ineligible-001", "cluster_a", eligibility_state=E),
            _hard("scn-X4-diversity-ineligible-001", "cluster_b", eligibility_state=E),
        ...
        [_relative("scn-X4-diversity-ineligible-001", "cluster_a", "ineligible", "diversity reorders eligible candidates only; paused candidate stays excluded", deferred=True)],
    ...
    "scn-X5-tie-diversity-001": _entry(
        ...
        ["IN-1", "IN-7"],
        [
            _hard("scn-X5-tie-diversity-001", "target_a", eligibility_state=E),
            _hard("scn-X5-tie-diversity-001", "target_b", eligibility_state=E),
            _hard("scn-X5-tie-diversity-001", "spread", eligibility_state=E),
        ...
        [_relative("scn-X5-tie-diversity-001", "target_a", "target_b", "equal score inputs resolve by frozen tiebreak key ascending", deferred=True)],
    ...
    "scn-X6-sparse-semantic-001": _entry(
        ...
        ["IN-1", "IN-5", "IN-6"],
        [
            _hard("scn-X6-sparse-semantic-001", "near", eligibility_state=E),
