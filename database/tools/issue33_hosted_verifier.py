...
EXPECTED_FOREIGN_KEY_CONTRACT: tuple[ForeignKeySpec, ...] = (
    ...
    ForeignKeySpec('fk_ontology_edges_objective_target_version', 'ontology_edges', ("objective_id", "target_entity_id", "target_entity_version"), 'learning_objectives', ("id", "entity_id", "entity_version"), 'NO ACTION'),
    ...
    ForeignKeySpec('fk_ontology_edges_source_version', 'ontology_edges', ("source_entity_id", "source_entity_version"), 'learning_entity_versions', ("entity_id", "version"), 'NO ACTION'),
    ...
    ForeignKeySpec('fk_ontology_edges_target_version', 'ontology_edges', ("target_entity_id", "target_entity_version"), 'learning_entity_versions', ("entity_id", "version"), 'NO ACTION'),
